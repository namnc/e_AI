"""
Auto-generated tests for offchain_signature domain.

Run: python domains/offchain_signature/test_profile.py
"""
...
def test_profile_loads():
    ...
    assert profile["meta"]["domain_name"] == "offchain_signature"
...
def test_h1_structure():
    """Test H1: Permit2 unlimited or long expiry"""
    profile = load_profile()
...
def test_h2_structure():
    """Test H2: EIP-712 typed data encoding token transfer"""
    profile = load_profile()
...
def test_h3_structure():
    """Test H3: setApprovalForAll to unknown operator"""
    profile = load_profile()
...
def test_h4_structure():
    """Test H4: Signature from unverified dApp origin"""
    profile = load_profile()
...
def test_h5_structure():
    """Test H5: Batch permit (multiple tokens)"""
    profile = load_profile()
...
def test_h6_structure():
    """Test H6: Seaport order below market price"""
    profile = load_profile()
