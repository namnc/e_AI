"""
Auto-generated tests for approval_phishing domain.

Run: python domains/approval_phishing/test_profile.py
"""
...
def test_profile_loads():
    ...
    assert profile["meta"]["domain_name"] == "approval_phishing"
...
def test_h1_structure():
    """Test H1: Unlimited token approval"""
    profile = load_profile()
...
def test_h2_structure():
    """Test H2: Unverified spender contract"""
    profile = load_profile()
...
def test_h4_structure():
    """Test H4: Suspicious function selector"""
    profile = load_profile()
